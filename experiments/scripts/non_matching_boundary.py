...
class ProblemDefinition:
    ...
    def exact_u(self, t: jnp.ndarray, x: jnp.ndarray) -> jnp.ndarray:
        return jnp.minimum(jnp.minimum(t, 1 - t), jnp.minimum(x, 1 - x))
...
def run(
    ...
    if make_plots:
        ...
        processor.plot_vs_time(
            ...
            filename="error_estimator_vs_training_time_scenario_3.png",
            y_type="fosls_loss",
            cutoff_time=200.0
        )
        processor.plot_vs_time(
            ...
            filename="l2_error_vs_training_time_scenario_3.png",
        ...
        processor.plot_vs_time(
            ...
            filename="v_error_vs_training_time_scenario_3.png",
            y_type="true_v_error",
            cutoff_time=200.0
        )
